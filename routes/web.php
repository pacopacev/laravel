...
Route::get('/all-userlogs', [HomeController::class, 'getUserLogs'])->middleware(['auth'])->name('all.user_logs');
Route::get('/del-log/{id}', [HomeController::class, 'delLog'])->middleware(['auth'])->name('del.log');
